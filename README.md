...
| Candidate Judge Model | Option A: Separability Score | Option A: Omega-Squared ($\omega^2$) | Option A: Cliff's Delta ($d_{\text{cliff}}$) | Option B: Combined Score | Option B: Omega-Squared ($\omega^2$) | Option B: Cliff's Delta ($d_{\text{cliff}}$) | Positional Bias (Pos 1 % / Pos 2 %) | Length Bias (Win Rate % / EV Margin) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
